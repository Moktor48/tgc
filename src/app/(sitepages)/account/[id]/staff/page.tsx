    ...
    <div className="flex w-full justify-center">
      <div className="newsletter flex w-1/2">
        <p>
          ...
          include {permissions?.specialist && "specialist "}{" "}
          {permissions?.representative && "representative "}{" "}
          {permissions?.admin && "admin "}{" "}
          {permissions?.highcouncil && "high council "}{" "}
          {permissions?.guildmaster && "guildmaster"}.
        </p>

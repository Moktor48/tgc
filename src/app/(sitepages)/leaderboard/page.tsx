    ...
    <main>
      ...
      <form method="post" action="" className="leaderboard-form">
        ...
        <input
          ...
          name="start_date"
          value="2024-01-30"
          className="leaderboard-input-date"
        />
        ...
        <input
          type="submit"
          value="Submit"
          className="leaderboard-btn btn btn-success"
        />
      </form>

      <div className="leaderboard text-xl font-bold">
        <h2 className="leaderboard-title">Leaderboard</h2>
        <div className="leaderboard-table overflow-x-auto">
          <div className="white-line-bar"></div>
          <table className="leaderboard-content table text-base">
            <thead className="leaderboard-headers text-lg font-bold">
              <tr>
                <th>User</th>
                <th>Rank</th>
                <th>Points</th>

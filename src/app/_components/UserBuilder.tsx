...
export default function UserBuilder() {
    ...
    const [userData, setUserData] = useState<User>({name: "", email: "", image: "", role: ""})
    const [staffData, setStaffData] = useState<Staff>({admin: false, specialist: false, representative: false, highcouncil: false, guildmaster: false})
    const [esoData, setEsoData] = useState<Game>({rank: "", raid: false, raidlead: false, mentor: false})
    const [swtorData, setSwtorData] = useState<Game>({rank: "", raid: false, raidlead: false, mentor: false})
    const [ffxivData, setFfxivData] = useState<Game>({rank: "", raid: false, raidlead: false, mentor: false})
    ...
    <div>
        <form onSubmit={handleSubmit}>
            ...
            <input 
                ...
                name="admin"
                onChange={() => setStaffData({...staffData, admin: !staffData.admin})}
            /><br />
            ...
            <input 
                ...
                onChange={() => setStaffData({...staffData, specialist: !staffData.specialist})}
            /><br />
            ...
            <input 
                ...
                onChange={() => setStaffData({...staffData, representative: !staffData.representative})}
            /><br />
            ...
            <input 
                ...
                onChange={() => setStaffData({...staffData, highcouncil: !staffData.highcouncil})}
            /><br />
            ...
            <input 
                ...
                onChange={() => setStaffData({...staffData, guildmaster: !staffData.guildmaster})}
            /><br />
            ...
            <input 
                ...
                onChange={() => setEsoData({...esoData, raidlead: !esoData.raidlead})}
            /><br />
            ...
            <input 
                ...
                onChange={() => setFfxivData({...ffxivData, raidlead: !ffxivData.raidlead})}
            /><br />
            ...
            <input 
                ...
                onChange={() => setFfxivData({...ffxivData, mentor: !ffxivData.mentor})}
            /><br />
            ...
            <input 
                ...
                onChange={() => setSwtorData({...swtorData, raidlead: !swtorData.raidlead})}
            /><br />
            ...
            <input 
                ...
                onChange={() => setSwtorData({...swtorData, mentor: !swtorData.mentor})}
            /><br />                   
            <button className="button-40" type="submit">MAGIC BUTTON</button>
        </form>
    </div>
  )
}
